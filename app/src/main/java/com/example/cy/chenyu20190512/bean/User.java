package com.example.cy.chenyu20190512.bean;
...
public class User {
    ...
    public static class ResultBean {
        /**
         * commodityId : 94
         * commodityName : 秋冬新款宽松套头绣花纯色连帽加绒加厚卫衣女装外套
         * masterPic : http://172.17.8.100/images/small/commodity/nz/wy/2/1.jpg
         * price : 129
         * saleNum : 0
         */
